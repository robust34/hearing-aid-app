...
class RoomSuggestion extends Model {
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'userId': _userId, 'roomId': _roomId, 'suggestion': _suggestion, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<RoomSuggestionModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<RoomSuggestionModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField USERID = QueryField(fieldName: "userId");
  static final QueryField ROOMID = QueryField(fieldName: "roomId");
  static final QueryField SUGGESTION = QueryField(fieldName: "suggestion");
...
class _RoomSuggestionModelType extends ModelType<RoomSuggestion> {
 ...
 */
@immutable
class RoomSuggestionModelIdentifier implements ModelIdentifier<RoomSuggestion> {
  final String id;
