...
class Specialty extends Model {
  ...
  Map<String, Object?> toMap() => {
    'id': id, 'specialty': _specialty, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };

  static final QueryModelIdentifier<SpecialtyModelIdentifier> MODEL_IDENTIFIER = QueryModelIdentifier<SpecialtyModelIdentifier>();
  static final QueryField ID = QueryField(fieldName: "id");
  static final QueryField SPECIALTY = QueryField(fieldName: "specialty");
...
class _SpecialtyModelType extends ModelType<Specialty> {
 ...
 */
@immutable
class SpecialtyModelIdentifier implements ModelIdentifier<Specialty> {
  final String id;
